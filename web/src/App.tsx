          ...
          <Dialog.Content
            ...
            <form className="mt-8 flex flex-col gap-4" >
              ...
              <footer className="mt-4 flex justify-end">
                <Dialog.Close
                  type="button"
                  className='bg-zinc-500 px-5 h-12 roumded-md font-semibold'
                >
                  Cancelar
                </Dialog.Close>
                <button
                  type="submit"
                  className='bg-violet-500 px-5 h-12 roumded-md font-semibold flex items-center gap-3 hover:bg-violet-600'
                >
